...
const AGENTS = [
  { id: 'clawfarm-planner',   role: 'planner',   model: 'blockrun/eco' },
  { id: 'clawfarm-setup',     role: 'setup',     model: 'blockrun/eco' },
  { id: 'clawfarm-developer', role: 'developer', model: 'blockrun/sonnet' },
  { id: 'clawfarm-verifier',  role: 'verifier',  model: 'blockrun/eco' },
  { id: 'clawfarm-tester',    role: 'tester',    model: 'blockrun/eco' },
  { id: 'clawfarm-pr',        role: 'pr',        model: 'blockrun/eco' },
  { id: 'clawfarm-reviewer',  role: 'reviewer',  model: 'blockrun/sonnet' },
];
